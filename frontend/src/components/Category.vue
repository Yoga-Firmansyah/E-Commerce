<template>
  <div class="card border-0 shadow rounded">
    <div class="card-body">
      ...
      <hr />
      <ul class="list-group list-group-horizontal" style="font-size: 3vmin">
        <router-link
          ...
          :key="category.id"
        >
          <img :src="category.image" style="width: 5vmin" />
          {{ category.name }}
          </router-link>

        <router-link :to="{name: 'categories'}"
          class="list-group-item text-center active shadow-sm font-weight-bold text-decoration-none mr-2"
